...
function onSearch(evt) {	
		...
		location.href = "index.php?com=catalogue&act=man&keyword="+keyword;
...
<script language="javascript">
	function select_onchange()
	{
		...
		window.location ="index.php?com=catalogue&act=man&id_list="+a.value;	
		return true;
	}
...
<table class="blue_table">
	...
	<tr>
        ...
        <td style="width:50%;"><a href="index.php?com=catalogue&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>                                 
		...
		<td style="width:5%;"><a href="index.php?com=catalogue&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png" /></a></td>
		<td style="width:5%;"><a href="index.php?com=catalogue&act=delete&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
