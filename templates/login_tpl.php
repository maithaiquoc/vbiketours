<form action="login.php" method="post" class="nhaplieu" id="login">

<table width="500" cellpadding="0" cellspacing="0" border="0" bgcolor="#6699CC" align="center" style="float:right">
...
<tr><td colspan="2" align="center">
	...
	<input type="submit" value="Đăng nhập" class="btn" style="background-color:rgb(190, 219, 79)" /></td>
