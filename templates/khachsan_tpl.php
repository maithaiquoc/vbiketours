<h3 class="title-menu"><?=_khachsan?></h3>
<div class="clear"></div>
		...
		<div class="block-khachsan-top">
            ...
            <div class="block-img-khachsan">
                 <a href="khach-san/<?=$tintuc[0]['id']?>-<?=$tintuc[0]['tenkhongdau']?>.html"><img src="<?=_upload_khachsan_l.$tintuc[0]['thumb']?>" alt="" title="" /></a>
            </div><!--block-img-khachsan-->
            <div class="block-info-khachsan">
                <h3> <a href="khach-san/<?=$tintuc[0]['id']?>-<?=$tintuc[0]['tenkhongdau']?>.html"><?=$tintuc[0]["ten_$lang"]?></a></h3>
                <p class="mota"><?=$tintuc[0]["mota_$lang"]?></p>
                <a href="khach-san/<?=$tintuc[0]['id']?>-<?=$tintuc[0]['tenkhongdau']?>.html" class="xemchitiet">Chi tiết</a>
        </div>
     ...
     <div class="block-khachsan <?php if(($i+1)%2==0) echo 'last';?>">
     	<h4> <a href="khach-san/<?=$tintuc[$i]['id']?>-<?=$tintuc[$i]['tenkhongdau']?>.html"><?=$tintuc[$i]["ten_$lang"]?></a></h4>
    	<div class="block-thumb-khachsan">
        	 <a href="khach-san/<?=$tintuc[$i]['id']?>-<?=$tintuc[$i]['tenkhongdau']?>.html"><img src="<?=_upload_khachsan_l.$tintuc[$i]['thumb']?>" alt="" title="" /></a>
        </div><!--block-thumb-->
