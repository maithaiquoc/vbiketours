...
redirect("index.php?com=blog&act=man_tag&id=".$_GET['id']."");
}
...
<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=blog&act=man_tag&id=<?= $_GET['id'] ?>'" class="btn">
</form>
