...
<form name="frm" method="post" action="index.php?com=about&act=save_item" enctype="multipart/form-data" class="nhaplieu">	
...
<input type="checkbox" id="bylink" name="bylink" checked="checked"><br />
