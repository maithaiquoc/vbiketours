...
<form name="frm" method="post" action="index.php?com=hotro&act=save_item" enctype="multipart/form-data" class="nhaplieu">
   ...
   <?php /*?> <b>Tên ( english )</b> <input type="text" name="ten_en" value="<?=$item['ten_en']?>" class="input" /><br /><?php */?>
	...
	<div>
	 ...
	 <textarea name="mota_vi" id="mota_vi"><?=@$item['mota_vi']?></textarea></div>
...
<?php /*?>
	...
	<div>
	 ...
	 <textarea name="mota_en" id="mota_en"><?=@$item['mota_en']?></textarea></div>
	...
	<input type="button" value="Exit" onclick="javascript:window.location='index.php?com=hotro&act=man'" class="btn" />
