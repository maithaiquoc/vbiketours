                    ...
                    <div class="home_new">                        
						...
						<ul class="home_new-right">
                           ...
                           <?php
								...
								$sql_dep="select ten_$lang,  mota_$lang,ngaytao, id,tenkhongdau, thumb,tinnoibat, photo,nguoitao from #_news where hienthi =1 order by stt,id desc limit 4";
...

								{
									...
									{										
											...
											?>
												...
												<li <?php if($j==0) echo "class=\"home_new-right-first\"" ?>>

														<img src="<?="upload/news/".$result_tinnoibat[$j]['photo']?>" />

														<a href="tin-tuc/<?=$result_tinnoibat[$j]['id']?>-<?=$result_tinnoibat[$j]['tenkhongdau']?>.html"><h3>       

															<?=$result_tinnoibat[$j]["ten_$lang"]?>

														</h3></a>                                

														<p class="date">

<?=date('d-m-Y h:i:s A',$result_tinnoibat[$j]['ngaytao'])?>

															by 

															<a href="javascript:;">

																<?=$result_tinnoibat[$j]["nguoitao"]?>
														...
														<p class="des_new">
															...
															<?=catchuoi($result_tinnoibat[$j]["mota_$lang"],90)?>      
                        ...
                        <p class="read_more"><a href="tin-tuc.html"><?=_docthem?>...</a></p>
...
<?php
	...
	$sql_dep="select ten_$lang, spmoi, mota_$lang, id,tenkhongdau, gia, thumb, photo from #_product where hienthi =1 and noibat>0 order by stt,id desc limit 4";
...
<?= catchuoi(str_replace("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;","",strip_tags($result_tieubieu[$j]["mota_$lang"],"")),90) ?>    
	...
	?></ul>
	 ...
	 <p class="read_more"><a href="san-pham.html"><?=_docthem?>...</a></p>
...
<?php																			
					...
					<div class="home_new_blog">

                        <p class="title_news"><?=_blogcamnhan?></p>

                        <ul class="home_blog-right">                            
...
-->
                    ...
                    <div class="home_videoo_right"  style="margin-top:10px;">

                        <p class="title_news">VIDEO</p>

                        <ul class="home_videoo">
...
<?php
                    ...
                    <div class="home_picture">
                        ...
                        <ul class="home_picture_right">

<?php

$d->reset();

$sql_bst="select id_list,id_cat,id_item,id,photo,thumb, masp, gia, ten_$lang,tenkhongdau,ngaytao,noidung_$lang from #_duan where hienthi=1 order by id desc limit 0,6";
...
?>
                    ...
                    <div class="home_marketing">
                        ...
                        <p class="title_news"><?=_quancao?></p>

                        <ul class="home_marketing_right">
