...
<form name="frm" method="post" action="index.php?com=bannerqc&act=save_banner_giua" enctype="multipart/form-data" class="nhaplieu">
	...
	<?php
	 ...
	 {
	 ?>
     <object width="745" height="340"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
             ...
             <embed src="<?=_upload_hinhanh.$item_banner['photo']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="745" height="340" scale="ExactFit"></embed>
            </object>
	 <?php 
	 } 
	 else 
	 ...
	 ?><br /><br />
	<b>Hình ảnh </b> <input type="file" name="file" /> <strong>Width:745px&nbsp;-&nbsp;Height:340px&nbsp;Type:&nbsp;.swf</strong><br />
