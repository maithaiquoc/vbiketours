...
<form name="frm" method="post" action="index.php?com=quangcaobody&act=save_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">	
...
?>
 ...
 <?php } ?>  
	...
	<b>Photo </b> <input type="file" name="file" /> <strong>Width: 50px ;Height:27px- Dạng:swf|jpg|gif|png|SWF|JPG|GIF|PNG</strong><br />
	...
	<b>Link: </b> <input name="link" value="<?=$item['link']?>" type="text" size="40"   />	
...
-->
	...
	<input type="button" value="Exit" onclick="javascript:window.location='index.php?com=quangcaobody&act=man_photo'" class="btn" />
