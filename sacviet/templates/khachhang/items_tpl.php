	...
	<tr>
		<td style="width:5%;" align="center"><?=$items[$i]['stt']?></td>       
		 <td style="width:30%;" align="center">
        	<?php
			$sql_danhmuc="select ten_vi from table_about_item where id='".$items[$i]['id_item']."'";
			$result=mysql_query($sql_danhmuc);
	 		$item_danhmuc =mysql_fetch_array($result);
	 		echo @$item_danhmuc['ten_vi'];
			?>  
        </td>
        <td style="width:50%;" align="center"><a href="index.php?com=about&act=edit&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>
		<td style="width:5%;">
		...
		<td style="width:5%;" align="center"><a href="index.php?com=about&act=edit&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png"  border="0"/></a></td>
