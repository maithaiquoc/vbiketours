...
<form name="frm" method="post" action="index.php?com=chinhsach&act=save" enctype="multipart/form-data" class="nhaplieu">       		
	 <b>Nội dung</b><br/>
	<div>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=chinhsach&act=man'" class="btn" />
</form>