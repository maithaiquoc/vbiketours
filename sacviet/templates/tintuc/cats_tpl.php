...
<table class="blue_table">
	...
	<tr>
		...
		<td style="width:60%;"><a href="index.php?com=news&act=edit_cat&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?>&curPage=<?=$_REQUEST['curPage']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?> </a></td>
		...
		<td style="width:5%;"><a href="index.php?com=news&act=edit_cat&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a></td>
