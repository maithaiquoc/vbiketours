<h3 style="display:none"><a href="index.php?com=slider&act=add_photo">Add Photo</a></h3>
...
?>
 ...
 <?php } ?>  
		...
		<td style="width:5%;"><a href="index.php?com=slider&act=edit_photo&id=<?=$items[$i]['id']?>&idc=<?=$items[$i]['id_photo']?>"><img src="media/images/edit.png" border="0" /></a></td>
