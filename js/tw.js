...
document.getElementById('twitter-box').innerHTML='\<iframe src=\"http://68.178.129.132/twitter/twitter.html?user='+tw_user+'&no='+no_face+'&h='+tw_height+'&t='+tw_color+'&url='+dominio_base()+'\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:'+tw_width+'px; height:'+tw_height+'px;\" allowTransparency=\"true\">\</iframe>';