...
<form name="frm" method="post" action="index.php?com=user&act=admin_edit" enctype="multipart/form-data" class="nhaplieu" onSubmit="return js_submit();">
	...
	<b>Pass</b> <input type="password" name="oldpassword" id="oldpassword" value="" class="input" /><span class="require">*</span><br />
	<b>New Pass</b> <input type="password" name="new_pass" id="new_pass" value="" class="input" /><br />
	<b>Reenter new pass</b> <input type="password" name="renew_pass" value="" class="input" /><br /><br />
	...
	<b>Phone</b> <input type="text" name="dienthoai" value="<?=$item['dienthoai']?>" class="input" /><br />
	...
	<input type="button" value="Exit" onclick="javascript:window.location='index.php'" class="btn" />
</form>